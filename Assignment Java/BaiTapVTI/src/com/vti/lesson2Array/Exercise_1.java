...
public class Exercise_1 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Exercise 1: 1 trường đại học cần 1 phần mềm để quản lý điểm của sinh viên.
		 * Bạn đang làm việc như người lập trình viên và bạn phải xây dựng 1 chương
		 * trình đáp ứng được các yêu cầu sau: 1. Tạo tên của sinh viên: a. Tạo 1 array
		 * có chứa 7 họ của sinh viên (tên của sinh viên không chứa dấu) b. Tạo 1 array
		 * có chứa 7 tên đệm của sinh viên (tên đệm của sinh viên không chứa dấu) c. Tạo
		 * 1 array có chứa 7 tên của sinh viên (tên của sinh viên không chứa dấu) Tạo 10
		 * tên đầy đủ của sinh viên (bao gồm 1 họ, 1 tên đệm và 1 tên) và đặt chúng vào
		 * trong 1 array mới. (Các tên phải khác nhau từng đôi một).
		 */
		...
		String[] ID = new String[] { "SV" + "1710311", "SV" + "1710312", "SV" + "1710313", "SV" + "1710314",
				"SV" + "1710315", "SV" + "1710316", "SV" + "1710317", "SV" + "1710318", "SV" + "1710319",
				"SV" + "1710310" };
		...
		for (int i = 0; i < 10; i++) {
			...
			int rdHo = rd.nextInt(7);
			int rdTenDem = rd.nextInt(7);
			int rdTen = rd.nextInt(7);

			tenSV[i] = ho[rdHo] + " " + tenDem[rdTenDem] + " " + ten[rdTen];
		}
