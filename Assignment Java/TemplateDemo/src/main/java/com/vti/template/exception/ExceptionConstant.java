...
public class ExceptionConstant {
	...
	public static final String MS_COMMON_ERROR_EXECUTING = "1 error found while executing";
	public static final int CODE_COMMON_ERROR_EXECUTING = 1;
